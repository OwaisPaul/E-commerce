import { ADD_TO_CART, REMOVE_ITEM, EMPTY_CART } from "./actionTypes.js";

const initState = {
  addedItems: [],
  total: 0,
};
//cartReducer function serves
//  as the central hub for handling state updates related to our shopping cart
